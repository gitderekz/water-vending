  ...
  <?php require_once 'process.php'; ?>
    ...
    <div class="row justify-content-center">
      <form action="process.php" method="POST">
        ...
        <div class="form-group">
          <label>Volume</label>
          <input type="text" name="volume" class="form-control" value="<?php echo $volume; ?>" placeholder="Volume" >
        </div>
        <div class="form-group">
          <label>Amount</label>
          <input type="text" name="amount" class="form-control" value="<?php echo $balance; ?>" placeholder="Amount">
        </div>            
